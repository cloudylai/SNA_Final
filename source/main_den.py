...
if __name__ == "__main__":
    clf = rf(n_estimators = 3000, n_jobs = -1, max_depth = 25) #classifier
    dirt = "../Gowalla_new/link_prediction/"
    global G
    G = nx.Graph()
    (L_train, Y_train) = read_train_file(dirt+"gowalla.train.txt")
    (L_test, Y_test) = read_test_file(dirt+"gowalla.test.txt" )
    ...
    #...
    read_users_info(dirt+"users_info_new.dat")

    global S
    S = {}# a dict of spot info
    read_spots_info(dirt+"spots_info.dat")
    ...
    #...
    read_checkins_info(dirt+"checkins_info.dat")
    add_H_edges()
